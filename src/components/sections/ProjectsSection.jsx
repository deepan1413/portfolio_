...
const ProjectImage = ({ project, index, isActive }) => {
            ...
            <div className="mac-window">
                ...
                <div className="image-container">
                    {image ? (
                        ...
                        <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJzpEkv-vlwrVppb-PQuWArI1sXR9vAYAwNg&s' alt={title} className="project-img" />
                    )}
                </div>
            </div>
        </motion.div>
...
// Map portfolio projects to component structure
const projects = portfolio.projects.map(proj => ({
    ...proj,
    techStack: proj.tech,
...
export const ProjectsSection = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            // Clear existing timeout to debounce scrolling state
            if (scrollTimeoutRef.current) {
                clearTimeout(scrollTimeoutRef.current);
            }

            // Set timeout to detect end of scrolling, regardless of whether it's manual or auto
            scrollTimeoutRef.current = setTimeout(() => {
                isScrollingRef.current = false;
                manualNavigationRef.current = false;
            }, 150);

            // Skip updating active project if we are manually navigating or if container doesn't exist yet
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-3/4 left-0 w-96 h-96 bg-cyan-500/5 rounded-full filter blur-3xl pointer-events-none" />
            </div>
